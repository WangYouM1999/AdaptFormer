...
weights_name = "buildformer_potsdam"
weights_path = "model_weights/potsdam/{}".format(weights_name)
test_weights_name = "buildformer_potsdam"
...
train_dataset = PotsdamDataset(data_root='data/potsdam/train', mode='train',mosaic_ratio=0.25, transform=train_aug)

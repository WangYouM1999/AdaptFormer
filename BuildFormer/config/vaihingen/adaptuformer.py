...
weights_name = "adaptformer-init-r18-512-crop-ms-e105"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "adaptformer-init-r18-512-crop-ms-e105"
...
#  define the network
net = AdaptFormer(num_classes=num_classes, decode_channels=64, num_heads=8)
...
val_dataset = VaihingenDataset(data_root='data/vaihingen/val',
                               transform=val_aug)

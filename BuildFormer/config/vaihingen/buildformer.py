...
weights_name = "buildformer_vaihingen"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "buildformer_vaihingen-v2"
...
pretrained_ckpt_path = "model_weights/whubuilding/buildformer_large_edge_all/best.ckpt"
...
train_dataset = VaihingenDataset(data_root='data/vaihingen/train', mode='train',mosaic_ratio=0.25, transform=train_aug)
